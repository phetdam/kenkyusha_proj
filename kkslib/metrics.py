...
def accuracies2rla(acc_df):
    pass

def accuracies2ela(acc_df):
    """
    given a properly formatted DataFrame produced by compute_accuracies or a
    comparable method, return a DataFrame of ELA statistics
    ...
    acc_df     DataFrame of accuracies for an estimator on different data sets
               ...
               column index of acc_df, save for the first column "acc_0", should
               have the format "acc_kind_level".
